...
#played cards
#player card
#0-9, 8 changes color, +4, +2, reverse, skip turnred blue green yellow
# direction value

from random import *
#need to fix +2,+4, and skip in the re
#cards=[[0,"blue"],[0,"green"],[0,"yellow"],[0,"red"],["reverse","none"]]
player1cards= []
player2cards=[]
player3cards=[]
playedcards=[]
...
#cards=[[0,"blue"],[0,"green"],[0,"yellow"],[0,"red"],[1,"blue"],[1,"green"],[1,"yellow"],[1,"red"],[2,"blue"],[2,"green"],[2,"yellow"],[2,"red"],[3,"blue"],[3,"green"],[3,"yellow"],[3,"red"],[4,"blue"],[4,"green"],[4,"yellow"],[4,"red"],[5,"blue"],[5,"green"],[5,"yellow"],[5,"red"],[6,"blue"],[6,"green"],[6,"yellow"],[6,"red"],[7,"blue"],[7,"green"],[7,"yellow"],[7,"red"],[8,"none"],[8,"none"],[8,"none"],[8,"none"],[9,"blue"],[9,"green"],[9,"yellow"],[9,"red"],["+4","none"],["+4","none"],["+4","none"],["+4","none"],["+2","blue"],["+2","green"],["+2","yellow"],["+2","red"],["skip","blue"],["skip","green"],["skip","yellow"],["skip","red"],[0,"blue"],[0,"green"],[0,"yellow"],[0,"red"],[1,"blue"],[1,"green"],[1,"yellow"],[1,"red"],[2,"blue"],[2,"green"],[2,"yellow"],[2,"red"],[3,"blue"],[3,"green"],[3,"yellow"],[3,"red"],[4,"blue"],[4,"green"],[4,"yellow"],[4,"red"],[5,"blue"],[5,"green"],[5,"yellow"],[5,"red"],[6,"blue"],[6,"green"],[6,"yellow"],[6,"red"],[7,"blue"],[7,"green"],[7,"yellow"],[7,"red"],[8,"none"],[8,"none"],[8,"none"],[8,"none"],[9,"blue"],[9,"green"],[9,"yellow"],[9,"red"],["+4","none"],["+4","none"],["+4","none"],["+4","none"],["+2","blue"],["+2","green"],["+2","yellow"],["+2","red"],["skip","blue"],["skip","green"],["skip","yellow"],["skip","red"],]
...
def uno():
    ...
    if turn[0] % 3 ==1:
        ...
        if card[0] == playedcards[int(len(playedcards)-1)][0] or card[1] == playedcards[int(len(playedcards)-1)][1]:
...
if len(player1cards) == 0:
    print("player 1 won the game",player1cards,player2cards,player3cards)
elif len(player2cards) == 0:
    print("player 2 won the game",player1cards,player2cards,player3cards)
else:
    print("player 3 won the game",player1cards,player2cards,player3cards)
